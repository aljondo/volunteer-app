...
export const SAVE_USER_REQUEST = 'FETCH_USERS_REQUEST'
export const SAVE_USER_SUCCESS = 'FETCH_USERS_SUCCESS'
export const SAVE_USER_FAILURE = 'FETCH_USERS_FAILURE'
