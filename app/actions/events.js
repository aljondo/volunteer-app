...
export const FETCH_EVENT_REQUEST = 'FETCH_EVENTS_REQUEST'
export const FETCH_EVENT_SUCCESS = 'FETCH_EVENTS_SUCCESS'
export const FETCH_EVENT_FAILURE = 'FETCH_EVENTS_FAILURE'
