...
import { updateName, updateEmail, clearUpdateFields, updateEvent } from '../../../actions/events/editEvent'
import OrgAboutMe from "../../../components/ProfileComponents/Organization/editEvent"
...
class OrgAboutMeContainer extends Component {
    ...
    applyUpdates(){
        this.props.updateEvent(this.props.updateFields);
    }
    ...
    updateManager(e){
        this.props.updateManager(e.target.value);
    }
